// Album Music Player v.1.6 - © 2022 | Designed & licenced for Mix Vibe Records | Developed : (Codix.dev) Mix Vibe Rec. Developers
// Add Tracklist Top
...
for (var i = 0; i < tracklist.length; ++i) {
 $('.aBm-Plist').append("<li class='pL-Gp-itm my-1 up-next' data-pLID='" + i + "'><div class='d-flex align-items-center'><div class='col-btn'><svg class='line' width='30' height='30' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><polygon fill='none' points='6.5,5 14.5,10 6.5,15'></polygon></svg></div><div class='col-md-6 pL-mTa'><span class='songtitle'>" + tracklist[i].song + "</span> - <span class='songtitle'>" + tracklist[i].artist + "</span></div><div class='ml-auto' style='margin-right: 20px;'>" + tracklist[i].length + "</div></div></li>");
}
// Detect IE/Edge
