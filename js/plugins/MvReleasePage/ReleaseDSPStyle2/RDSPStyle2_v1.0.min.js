...
* jQuery library-© Mix Vibe Records
* Release DSP List PluginStyle2 v.1.0 - b2root.dev */
for (var i = 0; i < pFlinks.length; ++i) {$('#pFm-bTns-2').append("<a class='css-o9o2ym "+ pFlinks[i].pfName + "' href= "+ pFlinks[i].link + " target='_blank'></a></li>");}
